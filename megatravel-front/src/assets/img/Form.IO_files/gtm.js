...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","page","value",["macro",1]],["map","fieldName","allowLinker","value","true"]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_autoLinkDomains":"form.io",
...
"_dc_gtm_"+String(c.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");v("require","displayfeatures",void 0,{cookieName:T})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==c.vtp_advertisingFeaturesType){var U="_dc_gtm_"+String(c.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");v("require","adfeatures",{cookieName:U})}C?v("send","pageview",C):v("send","pageview");c.vtp_autoLinkDomains&&Md(p,c.vtp_autoLinkDomains,!!c.vtp_useHashAutoLink,!!c.vtp_decorateFormsAutoLink);
